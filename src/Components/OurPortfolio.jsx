...
const OurPortfolio = () => {
  ...
  <div data-aos="flip-left"
    ...
    <div className="w-6/12 lg:p-14 mt-10 lg:mt-0">
      <h1 className="text-[#FE3E01] text-2xl text-center md:text-center lg:text-left md:text-4xl lg:text-5xl font-bold font-sourceSans">CHECK OUT OUR EVENT PLANNING SKILLS</h1>
      <p className="text-[#1e1e1e] text-center md:text-center lg:text-left py-6 font-poppins text-lg font-normal">We have been providing Corporate and business management services with huge success. Our Clients are very familiar and well established. They trust us and our services.</p>
      <div className="text-center md:text-center lg:text-justify ">
      <button className=" h-14 lg:w-[176px] rounded-lg font-poppins text-lg font-semibold hover:bg-[#ce3608] bg-[#FE3E01] text-white lg:text-lg btn-primary">Our Portfolio</button>
      </div>
    </div>
  </div>
</div>
